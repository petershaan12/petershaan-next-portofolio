    ...
    return (
      <a href={url} target="_blank" rel="noopener noreferrer">
        ...
        <div className="mt-2 px-2 py-1 w-full">
          ...
          {tags.map(tag => (
            <button key={tag} className="rounded-full bg-blue-200 px-3 py-1 text-xs mt-2 text-blue-800 font-semibold hover:text-white hover:bg-blue-600 dark:hover:text-white dark:hover:bg-blue-600 mr-2 dark:bg-blue-950 dark:text-blue-400">
              {tag}
            </button>
          ))}
        </div>
